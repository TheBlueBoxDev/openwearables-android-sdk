package com.openwearables.healthsdk.interfaces
 ...
 * to the [com.openwearables.healthsdk.data.entities.UnifiedHealthData] format before returning. The [SyncManager]
